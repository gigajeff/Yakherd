...
If a repository already has temporary process-hygiene instructions, preserve
them until native `yakherd exec` and cleanup checks are proven active.
A later reviewed, hash-pinned migration may
